...
Current public release: **7.4** (`versionCode 73`)
...
| Surface | In 7.0 |
|---|---|
| Pay code | Native QR plus a master eCode switch. Turn it off if unused; then the app neither fetches nor auto-refreshes pay codes. |
