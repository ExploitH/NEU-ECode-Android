...
| 场景 | 7.0 里的样子 |
|---|---|
| 付款码 | 原生二维码 + E码通功能总开关。不需要该功能可直接关闭；关闭后不取码、不自动刷新。 |
...
| **7.4** | **73** | E码通恢复上线；支持功能总开关；优化取码与余额刷新 |
| 7.3 | 72 | 暂时停用付款码 / e码通模块，仅保留课表与校内 VPN；付款码页展示教务系统更新暂停说明 |
